...
// //! Existem 2 arquiteturas de computaadores, Big-endian e Little-endian
// //!
// //! Big-endian: bytes mais significativos (o "big end") são armazenados primeiro
// //! Little-endian:  os bytes menos significativos (o "little end") são armazenados primeiro.
// //!
// //! Overflow: qunado há um transbordo para mais que o limite da memória
// //! Underflow: qunado há um transbordo para menos que o limite da memória
